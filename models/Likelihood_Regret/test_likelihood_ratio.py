...
if __name__=="__main__":
    ...
    parser.add_argument('--state_E', default='./saved_models/models/fmnist/netE_pixel.pth', help='path to encoder checkpoint')
    parser.add_argument('--state_G', default='./saved_models/models/fmnist/netG_pixel.pth', help='path to encoder checkpoint')

    parser.add_argument('--state_E_bg', default='./saved_models/models/fmnist/netE_pixel_bg.pth', help='path to encoder checkpoint')
    parser.add_argument('--state_G_bg', default='./saved_models/models/fmnist/netG_pixel_bg.pth', help='path to encoder checkpoint')

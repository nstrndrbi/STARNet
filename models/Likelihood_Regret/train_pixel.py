...
if __name__=="__main__":
    ...
    parser.add_argument('--experiment', default='./saved_models/models/fmnist', help='Where to store samples and models')
...
#                                            shuffle=True, num_workers=int(opt.workers))
    ...
    torch.save(netG.state_dict(), '{}/netG_pixel_simple.pth'.format(opt.experiment, ngf))
    torch.save(netE.state_dict(), '{}/netE_pixel_simple.pth'.format(opt.experiment, ngf))

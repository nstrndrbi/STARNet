...
def store_NLL(x, recon, mu, logvar, z):
    with torch.no_grad():
        ...
        #print("shape of cross_entropy:", cross_entropy.shape)
...
if __name__=="__main__":
    ...
    parser.add_argument('--num_iter', type=int, default=10, help='number of iters to optimize')
    ...
    parser.add_argument('--state_G', default='./saved_models/models/fmnist/netG_pixel.pth', help='path to decoder checkpoint')
